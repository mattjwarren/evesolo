...
if not (TEST or DEV):
	STATIC_ROOT = 'C:/web/www/evesolo_com/static'
else:
	if TEST:
		STATIC_ROOT = 'C:/web/www/evesolo_com_test/static'
	elif DEV:
		STATIC_ROOT = 'C:/web/www/evesolo_com_dev/static'
...
SECRET_KEY = 'wnkjfblaiebgajbefweufblajkbglkaseng-wgndzigwiegwer'
...
ROOT_URLCONF = 'evesolo_site.urls'
...
if not (TEST or DEV):
	TEMPLATE_DIRS = (
		...
		# Always use forward slashes, even on Windows.
		# Don't forget to use absolute paths, not relative paths.
		"C:/web/www/evesolo_com/templates"
	)
else:
	if TEST:
		TEMPLATE_DIRS = (
			...
			# Always use forward slashes, even on Windows.
			# Don't forget to use absolute paths, not relative paths.
			"C:/web/www/evesolo_com_test/templates"
		)
	elif DEV:
		TEMPLATE_DIRS = (
			# Put strings here, like "/home/html/django_templates" or "C:/www/django/templates".
			# Always use forward slashes, even on Windows.
			# Don't forget to use absolute paths, not relative paths.
			"C:/web/www/evesolo_com_dev/templates"
		)
